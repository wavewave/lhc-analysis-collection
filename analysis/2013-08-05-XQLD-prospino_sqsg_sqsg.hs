...
main = do 
  ...
  let cfgfile = args !! 0  
      ...
      filenames = map ((,,) <$> fst <*> snd <*> createRdirBName "sqsg_2l7j2x" . snd) datasublst   
...
cmd cfgfile jobfile (q,g) = "/home2/iankim/repo/src/lhc-analysis-collection/analysis/runProspino squarkgluino " ++ cfgfile ++ " " ++ show q ++ " " ++ show g ++ " --config=" ++ jobfile
