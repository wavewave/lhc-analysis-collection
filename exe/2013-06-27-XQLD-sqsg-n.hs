...
idx_sqsg_n_2l3j2x :: CrossID ProcSmplIdx
idx_sqsg_n_2l3j2x = mkCrossIDIdx (mkDICross p_sqsg_n_2l3j2x)
  ...
  getConfig fp >>= 
    maybe (return ()) (\ec -> do 
      ...
      evchainGen ADMXQLD111degen
        ssetup 
        ("Work20130627_sqsg_n","sqsg_n_2l3j2x") 
        param 
        map_sqsg_n_2l3j2x p_sqsg_n_2l3j2x 
        mgrs 
