...
idx_2sq_nn_2l2j2x :: CrossID ProcSmplIdx
idx_2sq_nn_2l2j2x = mkCrossIDIdx (mkDICross p_2sq_nn_2l2j2x)
  ...
  getConfig fp >>= 
    maybe (return ()) (\ec -> do 
      ...
      evchainGen ADMXQLD111degen
        ssetup 
        ("Work20130627_2sq_nn","2sq_nn_2l2j2x") 
        param 
        map_2sq_nn_2l2j2x p_2sq_nn_2l2j2x 
        mgrs 

      let wsetup' = getWorkSetupCombined ADMXQLD111degen ssetup param ("Work20130627_2sq_nn","2sq_nn_2l2j2x")  mgrs 
          wsetup = wsetup' { ws_storage = WebDAVRemoteDir "montecarlo/admproject/XQLDdegen/8TeV/scan_2sq_nn_2l2j2x"} 
