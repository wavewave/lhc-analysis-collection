{ 
  ...
  h_u100 -> Draw(); 
  h_u100 -> SetTitle("E_{T}^{miss}/M_{eff}(2 jet), M_{#tilde{g}}=M_{#tilde{q}}=1000 GeV");
  ...
  h_u500 -> Draw("same"); 
  h_u500 -> SetTitle("E_{T}^{miss}/M_{eff}(inc), M_{#tilde{g}}=M_{#tilde{q}}=1000 GeV");

  TLatex l5(0.05,50,"m_{N}=500"); 
  l5.SetTextColor(38);
