{ 
  ...
  TFile u100("ADMXUDD112degenMG1000.0MQ1000.0ML50000.0MN100.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MET.root");
  TH1F* h_u100 = (TH1F*) u100.Get("2jet"); 
  h_u100 -> SetLineColor(30); 
  h_u100 -> Draw(); 
  h_u100 -> SetTitle("M_{#tilde{g}}=1000 GeV, M_{#tilde{q}}=1000 GeV");
  ...
  TFile u300("ADMXUDD112degenMG1000.0MQ1000.0ML50000.0MN300.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MET.root");
  ...
  TFile u500("ADMXUDD112degenMG1000.0MQ1000.0ML50000.0MN500.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MET.root");
