{ 
  ...
  TFile s500("SimplifiedSUSYMN500.0MG1000.0MSQ1000.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MEFF.root"); 
  TH1F* h_s500 = (TH1F*) s500.Get("2jet");
  h_s500 -> SetLineColor(46); 
  h_s500 -> Draw(); 
  h_s500 -> SetTitle("M_{#tilde{g}}=1000 GeV, M_{#tilde{q}}=1000 GeV") ;
  h_s500 -> SetXTitle("M_{eff}(inc)"); 
  ...
  TFile s100("SimplifiedSUSYMN100.0MG1000.0MSQ1000.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MEFF.root"); 
  ...
  TFile u500("ADMXUDD112degenMG1000.0MQ1000.0ML50000.0MN500.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MEFF.root");
  TH1F* h_u500 = (TH1F*) u500.Get("2jet"); 
  h_u500 -> SetLineColor(38); 
  h_u500 -> Draw("same"); 
  h_u500 -> SetTitle("M_{eff}(inc), M_{#tilde{g}}=M_{#tilde{q}}=1000 GeV");

  TLatex l5(190,50,"m_{N}=500"); 
  l5.SetTextColor(38);
   
  l5.Draw("same");


  TFile u100("ADMXUDD112degenMG1000.0MQ1000.0ML50000.0MN100.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MEFF.root");
  TH1F* h_u100 = (TH1F*) u100.Get("2jet"); 
  h_u100 -> SetLineColor(30); 
  h_u100 -> Draw("same"); 
  h_u100 -> SetTitle("M_{eff}(inc), M_{N} = 100 GeV, M_{#tilde{g}}=M_{#tilde{q}}=1000 GeV");

  TLatex l1(150,40,"m_{N}=100");
  l1.SetTextColor(30);  
  ...
  TFile u300("ADMXUDD112degenMG1000.0MQ1000.0ML50000.0MN300.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MEFF.root");
  ...
  TFile s300("SimplifiedSUSYMN300.0MG1000.0MSQ1000.0_total_LHC8ATLAS_NoMatch_NoCut_AntiKT0.4_NoTau_Set_MEFF.root"); 
  TH1F* h_s300 = (TH1F*) s300.Get("2jet");   
  h_s300 -> SetLineColor(44); 
  h_s300 -> Draw("same"); 

  TLatex l3(170,80,"m_{N}=300"); 
  l3.SetTextColor(35); 
